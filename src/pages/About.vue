...
<div class="alert alert-info">
  <div class="flex-1">
    ...
    <label>Testing alerts and other components from mamba and daisyUI</label>
  </div>
</div>

	<div class="max-w-md p-8 mx-auto rounded-lg dark:bg-coolGray-900 dark:text-coolGray-100">
		<div class="flex justify-between space-x-8">
			<div class="flex flex-col items-center">
				...
				<h1 class="text-xl font-semibold">Texas</h1>
			</div>
			<span class="font-bold text-8xl">14°</span>
		</div>
		<div class="flex justify-between mt-8 space-x-4 dark:text-coolGray-400">
